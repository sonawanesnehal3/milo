import { g as getConfig, d as loadStyle, c as createTag, l as localizeLink, b as getMetadata } from './global-footer-92adaea3.js';
        ...
        if (iframe) {
          const _temp = function () {
            if (dialog.classList.contains('commerce-frame')) {
              return Promise.resolve(import('./modal.merch-5ec815fb.js')).then(function ({
...
export { closeModal, init as default, delayedModal, findDetails, getHashParams, getModal, sendAnalytics };
//# sourceMappingURL=modal-6e215c97.js.map
