    ...
    return Promise.resolve(fetch(`${config.contentRoot ?? ''}/georoutingv2.json`)).then(function (resp) {
      ...
      const _temp13 = function () {
        if (!resp.ok) {
          ...
          return Promise.resolve(Promise.resolve().then(function () { return require('./georouting-e3667b2f.js'); })).then(function ({
...
const getDetails = function (currentPage, localeMatches, geoData) {
  return Promise.resolve(getAvailableLocales(localeMatches)).then(function (availableLocales) {
    ...
    const _temp3 = function () {
      if (innerWidth < 480) {
        return Promise.resolve(Promise.resolve().then(function () { return require('./getMobileBg-c3f2ac58.js'); })).then(function ({
          default: getMobileBg
        }) {
...
exports["default"] = loadGeoRouting;
exports.getCookie = getCookie;
//# sourceMappingURL=georoutingv2-74ca8d0a.js.map
