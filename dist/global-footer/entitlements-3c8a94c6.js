...
const getEntitlementMap = function () {
  try {
    ...
    return Promise.resolve(Promise.resolve().then(function () { return require('./stage-entitlements-492bacaf.js'); })).then(function ({
...
exports.getEntitlementMap = getEntitlementMap;
//# sourceMappingURL=entitlements-3c8a94c6.js.map
