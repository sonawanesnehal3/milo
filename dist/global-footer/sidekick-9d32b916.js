...
function init({
  ...
  const sendToCaasListener = function (e) {
    try {
      ...
      return Promise.resolve(Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('https://milo.adobe.com/tools/send-to-caas/send-to-caas.js')); })).then(function ({
        sendToCaaS
      }) {
        sendToCaaS({
          host,
  ...
  document.addEventListener('send-to-caas', function (e) {
    try {
      ...
      return Promise.resolve(Promise.resolve().then(function () { return require('./send-to-caas-d58a79a7.js'); })).then(function ({
        sendToCaaS
      }) {
        sendToCaaS({
          host,
...
//# sourceMappingURL=sidekick-9d32b916.js.map
