 ...
 */
const SYNTHETIC_BLOCKS = ['adobe-logo', 'breadcrumbs', 'column-break', 'cross-cloud-menu', 'gnav-brand', 'gnav-promo', 'large-menu', 'library-metadata', 'link-group', 'profile', 'region-selector', 'search', 'social'];
...
export { showError };
//# sourceMappingURL=fallback-7aef520c.js.map
