...
const documentPostSectionLoading = function (config) {
  try {
    function _temp23() {
      loadFooter();
      return Promise.resolve(Promise.resolve().then(function () { return require('./favicon-eed43109.js'); })).then(function ({
        default: loadFavIcon
      }) {
        ...
        initSidekick();
        return Promise.resolve(Promise.resolve().then(function () { return require('./delayed-a79adc31.js'); })).then(function ({
          default: delayed
        }) {
    ...
    if (appendage) {
      Promise.resolve().then(function () { return require('./title-append-1ef6ee7c.js'); }).then(module => module.default(appendage));
    }
    if (getMetadata('seotech-structured-data') === 'on' || getMetadata('seotech-video-url')) {
      Promise.resolve().then(function () { return require('./seotech-5df838a3.js'); }).then(module => module.default({
    ...
    const _temp22 = function () {
      if (richResults) {
        return Promise.resolve(Promise.resolve().then(function () { return require('./richresults-f08faf6c.js'); })).then(function ({
...
const loadDeferred = function (area, blocks, config) {
  try {
    ...
    if (config.links === 'on') {
      ...
      Promise.resolve().then(function () { return require('./links-159f4154.js'); }).then(mod => mod.default(path, area));
    }
    if (config.locale?.ietf === 'ja-JP') {
      // Japanese word-wrap
      Promise.resolve().then(function () { return require('./japanese-word-wrap-c7a5ec37.js'); }).then(({
  ...
  try {
    function _temp21() {
      function _temp19() {
        function _temp17() {
          loadTemplate();
          return Promise.resolve(Promise.resolve().then(function () { return require('./fonts-6a549a1f.js'); })).then(function ({
            default: loadFonts
          }) {
            loadFonts(config.locale, loadStyle);
            if (config.mep?.preview) {
              Promise.resolve().then(function () { return require('./preview-65955aa6.js'); }).then(({
    ...
    const _temp20 = function () {
      if (georouting === 'on') {
        return Promise.resolve(Promise.resolve().then(function () { return require('./georoutingv2-74ca8d0a.js'); })).then(function ({
  ...
  try {
    ...
    return Promise.resolve(combineMepSources(persEnabled, promoEnabled, mepParam)).then(function (persManifests) {
      ...
      function _temp15(_result) {
        ...
        return Promise.resolve(Promise.resolve().then(function () { return require('./personalization-b328591c.js'); })).then(function ({
          preloadManifests,
          applyPers
        }) {
...
const loadMartech = function ({
  ...
  try {
    ...
    loadIms().catch(() => {});
    return Promise.resolve(Promise.resolve().then(function () { return require('./martech-c0cfa2b9.js'); })).then(function ({
      default: initMartech
    }) {
...
const decorateFooterPromo = function (doc = document) {
  try {
    ...
    return Promise.resolve(Promise.resolve().then(function () { return require('./footer-promo-d8ca713d.js'); })).then(function ({
...
const decorateIcons = function (area, config) {
  try {
    ...
    return Promise.resolve(new Promise(resolve => {
      ...
      return Promise.resolve(Promise.resolve().then(function () { return require('./icons-19a87033.js'); })).then(function ({
        default: loadIcons
      }) {
      ...
      (function () {
        try {
          ...
          const _temp4 = _catch$1(function () {
            return Promise.resolve((function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(`${blockPath}.js`)).then(function ({
              default: init
            }) {
            ...
            const _temp3 = function () {
              if (config.env.name !== 'prod') {
                return Promise.resolve(Promise.resolve().then(function () { return require('./fallback-e8206a40.js'); })).then(function ({
                  showError
                }) {
      ...
      (function () {
        try {
          ...
          const _temp = _catch$1(function () {
            return Promise.resolve((function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(`${base}/templates/${name}/${name}.js`)).then(function () {});
          }, function (err) {
  ...
  [...images].forEach(img => {
    ...
    try {
      ...
      if (href.includes('.mp4')) {
        ...
        if (icon) {
          Promise.resolve().then(function () { return require('./image-video-link-a8ba8bcd.js'); }).then(mod => mod.default(picParent, aTag, icon));
        } else {
          aTag.append(pic);
        }
      }
...
const combineMepSources = function (persEnabled, promoEnabled, mepParam) {
  try {
    ...
    const _temp6 = function () {
      if (promoEnabled) {
        return Promise.resolve(Promise.resolve().then(function () { return require('./promo-utils-cb033454.js'); })).then(function ({
...
function initSidekick() {
  const initPlugins = function () {
    try {
      return Promise.resolve(Promise.resolve().then(function () { return require('./sidekick-9d32b916.js'); })).then(function ({
        default: init
      }) {
        init({
          createTag,
...
function decorateMeta() {
  ...
  window.addEventListener('modal:open', function (e) {
    try {
      ...
      return Promise.resolve(Promise.resolve().then(function () { return require('./modal-3f22759c.js'); })).then(function ({
        findDetails,
        getModal
      }) {
  ...
  window.lana = {
    log: function () {
      try {
        ...
        return Promise.resolve(Promise.resolve().then(function () { return require('./lana-4d2fe5c0.js'); })).then(function () {
      ...
      return Promise.resolve(res.text()).then(function (text) {
        function _temp5() {
          function _temp3() {
            ...
            if (blocks.length) {
              Promise.resolve().then(function () { return require('./martech-metadata-866acde7.js'); }).then(({
                default: decorate
...
function loadBlock(path) {
  return (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(path).then(module => module.default);
}
...
exports.decorateSectionAnalytics = decorateSectionAnalytics;
exports.getConfig = getConfig;
exports.getMetadata = getMetadata;
exports.init = init;
exports.loadArea = loadArea;
exports.loadIms = loadIms;
exports.loadLink = loadLink;
exports.loadScript = loadScript;
exports.loadStyle = loadStyle;
exports.localizeLink = localizeLink;
exports.processTrackingLabels = processTrackingLabels;
exports.updateConfig = updateConfig;
exports.utils = utils;
//# sourceMappingURL=global-footer-26f98613.js.map
