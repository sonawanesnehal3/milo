import { g as getConfig$1, b as getMetadata } from './global-footer-92adaea3.js';
  ...
  return [() => tags, function () {
    try {
      ...
      function _temp2(_result) {
        return _exit ? _result : Promise.resolve(import('./caas-tags-74ff4aa9.js')).then(function ({
          default: caasTags
        }) {
  ...
  try {
    ...
    const _temp5 = function () {
      if (!getLocale) {
        ...
        return Promise.resolve(import('./global-footer-92adaea3.js').then(function (n) { return n.k; })).then(function ({
...
export { loadTingleModalFiles, sendToCaaS, showAlert, showConfirm };
//# sourceMappingURL=send-to-caas-fac81f50.js.map
