...
function sampleRUM(checkpoint, data = {}) {
  ...
  const defer = fnname => {
    sampleRUM[fnname] = sampleRUM[fnname] || function () {
      return sampleRUM.defer.push({
        fnname,
  ...
  sampleRUM.drain = sampleRUM.drain || ((dfnname, fn) => {
    ...
    sampleRUM.defer.filter(({
      fnname
    }) => dfnname === fnname).forEach(({
      fnname,
      args
...
exports.addRumListeners = addRumListeners;
exports.sampleRUM = sampleRUM;
//# sourceMappingURL=samplerum-c14e9218.js.map
